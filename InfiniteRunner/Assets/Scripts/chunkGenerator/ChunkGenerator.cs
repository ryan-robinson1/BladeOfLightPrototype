...
public class ChunkGenerator : MonoBehaviour
{
    ...
    void spawnStreetLights()
    {
        for (int i = 0; i < 5; i++)
        {
            ...
            {
                GameObject.Instantiate(streetLight, new Vector3(streetLightSpawnX, 0.16f, 5), Quaternion.identity);
            }
            if (Random.Range(0, 5) != 3)
            {
                GameObject.Instantiate(streetLight, new Vector3(streetLightSpawnX, 0.16f, -5), Quaternion.Euler(0,180,0));
            }
